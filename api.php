<?php
// File Hash: 9597dbecf6fbd486e92ce57d63447ebb
...
namespace PackTypebot\DeliveryPro\Cache\Base {
    use PackTypebot\DeliveryPro\Cache\Cache;
...
namespace PackTypebot\DeliveryPro\Cache {
    interface Cache
    {
        public function set(string $key, string $value, int $ttl = 0): bool;
        public function get(string $key): string;
...
namespace PackTypebot\DeliveryPro\Cache {
    use PackTypebot\DeliveryPro\Cache\Base\BaseCache;
...
namespace PackTypebot\DeliveryPro\Column\Reflection {
    use PackTypebot\DeliveryPro\Database\GenericReflection;
...
namespace PackTypebot\DeliveryPro\Column {
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedColumn;
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedTable;
    use PackTypebot\DeliveryPro\Database\GenericDB;
...
namespace PackTypebot\DeliveryPro\Column {
    use PackTypebot\DeliveryPro\Cache\Cache;
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedDatabase;
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedTable;
    use PackTypebot\DeliveryPro\Database\GenericDB;
...
namespace PackTypebot\DeliveryPro\Config\Base {
...
namespace PackTypebot\DeliveryPro\Config {
    use PackTypebot\DeliveryPro\Config\Base\ConfigInterface;
...
namespace PackTypebot\DeliveryPro\Controller {
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use PackTypebot\DeliveryPro\Cache\Cache;
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
...
namespace PackTypebot\DeliveryPro\Controller {
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use PackTypebot\DeliveryPro\Column\DefinitionService;
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\RequestUtils;
...
namespace PackTypebot\DeliveryPro\Controller {
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use PackTypebot\DeliveryPro\GeoJson\GeoJsonService;
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\RequestUtils;
...
namespace PackTypebot\DeliveryPro\Controller {
    use Psr\Http\Message\ResponseInterface;
    use PackTypebot\DeliveryPro\Record\Document\ErrorDocument;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\ResponseFactory;
    use PackTypebot\DeliveryPro\ResponseUtils;
...
namespace PackTypebot\DeliveryPro\Controller {
    ...
    use Psr\Http\Message\ServerRequestInterface;
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\OpenApi\OpenApiService;
...
namespace PackTypebot\DeliveryPro\Controller {
    ...
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\Record\RecordService;
    use PackTypebot\DeliveryPro\RequestUtils;
...
namespace PackTypebot\DeliveryPro\Database {
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedColumn;
...
namespace PackTypebot\DeliveryPro\Database {
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedColumn;
    use PackTypebot\DeliveryPro\Record\Condition\AndCondition;
    use PackTypebot\DeliveryPro\Record\Condition\ColumnCondition;
    use PackTypebot\DeliveryPro\Record\Condition\Condition;
    use PackTypebot\DeliveryPro\Record\Condition\NoCondition;
    use PackTypebot\DeliveryPro\Record\Condition\NotCondition;
    use PackTypebot\DeliveryPro\Record\Condition\OrCondition;
    use PackTypebot\DeliveryPro\Record\Condition\SpatialCondition;
...
namespace PackTypebot\DeliveryPro\Database {
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedTable;
    use PackTypebot\DeliveryPro\Middleware\Communication\VariableStore;
    use PackTypebot\DeliveryPro\Record\Condition\ColumnCondition;
    use PackTypebot\DeliveryPro\Record\Condition\Condition;
    class GenericDB
    {
...
namespace PackTypebot\DeliveryPro\Database {
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedColumn;
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedTable;
    use PackTypebot\DeliveryPro\Database\LazyPdo;
...
namespace PackTypebot\DeliveryPro\GeoJson {
...
namespace PackTypebot\DeliveryPro\GeoJson {
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\GeoJson\FeatureCollection;
    use PackTypebot\DeliveryPro\Record\RecordService;
...
namespace PackTypebot\DeliveryPro\Middleware\Base {
    use Psr\Http\Server\MiddlewareInterface;
    use PackTypebot\DeliveryPro\Controller\Responder;
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\Config\Base\ConfigInterface;
...
namespace PackTypebot\DeliveryPro\Middleware\Communication {
    class VariableStore
    {
...
namespace PackTypebot\DeliveryPro\Middleware\Router {
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use PackTypebot\DeliveryPro\Middleware\Base\Middleware;
...
namespace PackTypebot\DeliveryPro\Middleware\Router {
    ...
    use PackTypebot\DeliveryPro\Middleware\Base\Middleware;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\Record\PathTree;
    use PackTypebot\DeliveryPro\RequestUtils;
...
namespace PackTypebot\DeliveryPro\Middleware {
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use PackTypebot\DeliveryPro\Controller\Responder;
...
namespace PackTypebot\DeliveryPro\Middleware {
    ...
    {
        private function getChaveSecreta() {
            try {
                ...
                $stmt = $pdo->query("SELECT chave_secreta FROM license_codes WHERE is_active = 1 ORDER BY id DESC LIMIT 1");
                if (!$stmt) {
                    throw new \Exception('Erro ao consultar chave secreta');
                }

                $result = $stmt->fetch(\PDO::FETCH_ASSOC);
                
                if (!$result || !isset($result['chave_secreta']) || empty($result['chave_secreta'])) {
                    throw new \Exception('Nenhuma chave secreta ativa encontrada');
                }

                return $result['chave_secreta'];

            } catch (\Exception $e) {
                error_log("[ERROR] Erro ao buscar chave secreta: " . $e->getMessage());
                throw new \Exception('Erro ao buscar chave secreta: ' . $e->getMessage());
            }
        }
        ...
        public function process(ServerRequestInterface $request, RequestHandlerInterface $next): ResponseInterface
        {
            try {
                ...
                error_log("[DEBUG] Headers recebidos: " . print_r($headers, true));
                
                if (!isset($headers['Authorization'])) {
                    return $this->responder->error(ErrorCode::AUTHENTICATION_REQUIRED, 'Token de autenticação não fornecido.');
                }
                ...
                if (stripos($authHeader, 'Bearer ') !== 0) {
                    return $this->responder->error(ErrorCode::AUTHENTICATION_FAILED, 'Tipo de autenticação inválido.');
                }

                $token = substr($authHeader, 7);
                $tokenParts = explode('.', $token);
                
                error_log("[DEBUG] Token parts: " . print_r($tokenParts, true));
                
                if (count($tokenParts) !== 3) {
                    return $this->responder->error(ErrorCode::AUTHENTICATION_FAILED, 'Estrutura do token inválida.');
                }
                ...
                error_log("[DEBUG] Decoded header: " . print_r($decodedHeader, true));
                error_log("[DEBUG] Decoded payload: " . print_r($decodedPayload, true));
                
                $chave_secreta = $this->getChaveSecreta();
                
                error_log("[DEBUG] Usando chave secreta: " . $chave_secreta);
                
                $validSignature = hash_hmac('sha256', "$header.$payload", $chave_secreta, true);
                $base64UrlSignatureCheck = str_replace(['+', '/', '='], ['-', '_', ''], base64_encode($validSignature));

                error_log("[DEBUG] Assinatura recebida: " . $signature);
                error_log("[DEBUG] Assinatura calculada: " . $base64UrlSignatureCheck);

                if ($base64UrlSignatureCheck !== $signature) {
                    return $this->responder->error(ErrorCode::AUTHENTICATION_FAILED, 'Assinatura do token inválida - recebida: ' . $signature . ' calculada: ' . $base64UrlSignatureCheck);
                }
                ...
                error_log("[ERROR] Erro na autenticação: " . $e->getMessage());
                return $this->responder->error(ErrorCode::AUTHENTICATION_FAILED, $e->getMessage());
            }
        }
    }
}
namespace PackTypebot\DeliveryPro\Middleware {
    ...
    use Psr\Http\Server\RequestHandlerInterface;
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\Config\Config;
    use PackTypebot\DeliveryPro\Controller\Responder;
    use PackTypebot\DeliveryPro\Database\GenericDB;
    use PackTypebot\DeliveryPro\Middleware\Base\Middleware;
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\Record\Condition\ColumnCondition;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\Record\OrderingInfo;
    use PackTypebot\DeliveryPro\RequestUtils;
...
namespace PackTypebot\DeliveryPro\Middleware {
    ...
    use PackTypebot\DeliveryPro\Middleware\Router\Router;
    use PackTypebot\DeliveryPro\Record\ErrorCode;
    use PackTypebot\DeliveryPro\Record\FilterInfo;
    use PackTypebot\DeliveryPro\RequestUtils;
...
namespace PackTypebot\DeliveryPro\OpenApi {
    use Psr\Http\Message\ServerRequestInterface;
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\OpenApi\OpenApiDefinition;
...
namespace PackTypebot\DeliveryPro\OpenApi {
    use Psr\Http\Message\ServerRequestInterface;
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\OpenApi\OpenApiBuilder;
    use PackTypebot\DeliveryPro\RequestFactory;
...
namespace PackTypebot\DeliveryPro\Record\Condition {
...
namespace PackTypebot\DeliveryPro\Record\Document {
    use PackTypebot\DeliveryPro\Record\ErrorCode;
...
namespace PackTypebot\DeliveryPro\Record {
    use PackTypebot\DeliveryPro\Column\Reflection\ReflectedTable;
...
namespace PackTypebot\DeliveryPro\Record {
    ...
    class ErrorCode
    {
        ...
        private $values = [
            0000 => ["Sucesso", ResponseFactory::OK],
            1000 => ["Rota '%s' não encontrada", ResponseFactory::NOT_FOUND],
            1001 => ["Tabela '%s' não encontrada", ResponseFactory::NOT_FOUND],
            1002 => ["Quantidade de argumentos incompatível em '%s'", ResponseFactory::UNPROCESSABLE_ENTITY],
            1003 => ["Registro '%s' não encontrado", ResponseFactory::NOT_FOUND],
            1004 => ["Origem '%s' é proibida", ResponseFactory::FORBIDDEN],
            1005 => ["Coluna '%s' não encontrada", ResponseFactory::NOT_FOUND],
            1006 => ["Tabela '%s' já existe", ResponseFactory::CONFLICT],
            1007 => ["Coluna '%s' já existe", ResponseFactory::CONFLICT],
            1008 => ["Não foi possível ler a mensagem HTTP", ResponseFactory::UNPROCESSABLE_ENTITY],
            1009 => ["Exceção de chave duplicada", ResponseFactory::CONFLICT],
            1010 => ["Violação de integridade de dados", ResponseFactory::CONFLICT],
            1011 => ["Autenticação necessária", ResponseFactory::UNAUTHORIZED],
            1012 => ["Falha de autenticação '%s'", ResponseFactory::FORBIDDEN],
            1013 => ["Falha na validação de entrada '%s'", ResponseFactory::UNPROCESSABLE_ENTITY],
            1014 => ["Operação proibida", ResponseFactory::FORBIDDEN],
            1015 => ["Operação '%s' não suportada", ResponseFactory::METHOD_NOT_ALLOWED],
            1016 => ["Bloqueado temporária ou permanentemente", ResponseFactory::FORBIDDEN],
            1017 => ["Token XSRF inválido ou ausente", ResponseFactory::FORBIDDEN],
            1018 => ["Apenas requisições AJAX são permitidas para '%s'", ResponseFactory::FORBIDDEN],
            1019 => ["Paginação proibida", ResponseFactory::FORBIDDEN],
            1020 => ["Usuário '%s' já existe", ResponseFactory::CONFLICT],
            1021 => ["Senha muito curta (<%d caracteres)", ResponseFactory::UNPROCESSABLE_ENTITY],
            1022 => ["Nome de usuário está vazio ou contém apenas espaços", ResponseFactory::UNPROCESSABLE_ENTITY],
            1023 => ["Chave primária para a tabela '%s' não encontrada", ResponseFactory::NOT_FOUND],           
...
namespace PackTypebot\DeliveryPro\Record {
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\Database\GenericDB;
    use PackTypebot\DeliveryPro\Record\Document\ListDocument;
    class RecordService
    {
        private $db;
        private $reflection;
...
namespace PackTypebot\DeliveryPro {
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use PackTypebot\DeliveryPro\Cache\CacheFactory;
    use PackTypebot\DeliveryPro\Column\DefinitionService;
    use PackTypebot\DeliveryPro\Column\ReflectionService;
    use PackTypebot\DeliveryPro\Config\Config;
    use PackTypebot\DeliveryPro\Controller\CacheController;
    use PackTypebot\DeliveryPro\Controller\ColumnController;
    use PackTypebot\DeliveryPro\Controller\GeoJsonController;
    use PackTypebot\DeliveryPro\Controller\JsonResponder;
    use PackTypebot\DeliveryPro\Controller\OpenApiController;
    use PackTypebot\DeliveryPro\Controller\RecordController;
    use PackTypebot\DeliveryPro\Controller\StatusController;
    use PackTypebot\DeliveryPro\Database\GenericDB;
    use PackTypebot\DeliveryPro\GeoJson\GeoJsonService;
    use PackTypebot\DeliveryPro\Middleware\TokenAuthMiddleware;
    use PackTypebot\DeliveryPro\Middleware\ApiKeyDbAuthMiddleware;
    use PackTypebot\DeliveryPro\Middleware\AuthorizationMiddleware;
    use PackTypebot\DeliveryPro\Middleware\BasicAuthMiddleware;
    use PackTypebot\DeliveryPro\Middleware\CorsMiddleware;
    use PackTypebot\DeliveryPro\Middleware\CustomizationMiddleware;
    use PackTypebot\DeliveryPro\Middleware\DbAuthMiddleware;
    use PackTypebot\DeliveryPro\Middleware\FirewallMiddleware;
    use PackTypebot\DeliveryPro\Middleware\IpAddressMiddleware;
    use PackTypebot\DeliveryPro\Middleware\JoinLimitsMiddleware;
    use PackTypebot\DeliveryPro\Middleware\JsonMiddleware;
    use PackTypebot\DeliveryPro\Middleware\JwtAuthMiddleware;
    use PackTypebot\DeliveryPro\Middleware\MultiTenancyMiddleware;
    use PackTypebot\DeliveryPro\Middleware\PageLimitsMiddleware;
    use PackTypebot\DeliveryPro\Middleware\ReconnectMiddleware;
    use PackTypebot\DeliveryPro\Middleware\Router\SimpleRouter;
    use PackTypebot\DeliveryPro\Middleware\SanitationMiddleware;
    use PackTypebot\DeliveryPro\Middleware\SslRedirectMiddleware;
    use PackTypebot\DeliveryPro\Middleware\TextSearchMiddleware;
    use PackTypebot\DeliveryPro\Middleware\ValidationMiddleware;
    use PackTypebot\DeliveryPro\Middleware\WpAuthMiddleware;
    use PackTypebot\DeliveryPro\Middleware\XmlMiddleware;
    use PackTypebot\DeliveryPro\Middleware\XsrfMiddleware;
    use PackTypebot\DeliveryPro\OpenApi\OpenApiService;
    use PackTypebot\DeliveryPro\Record\RecordService;
    class Api implements RequestHandlerInterface
    {
        ...
        public function __construct(Config $config)
        {
            ...
            $prefix = sprintf('DeliveryPro-%s-', substr($config->getUID(), 0, 8));
            ...
            foreach ($config->getMiddlewares() as $middleware) {
                switch ($middleware) {
                    ...
                    case 'firewall':
                        ...
                        break;
                    case 'TokenAuth':
                        new TokenAuthMiddleware($router, $responder, $config, $middleware);
                        break;
                    case 'apiKeyDbAuth':
...
namespace PackTypebot\DeliveryPro {
    use PackTypebot\DeliveryPro\Api;
    use PackTypebot\DeliveryPro\Config\Config;
    use PackTypebot\DeliveryPro\RequestFactory;
    use PackTypebot\DeliveryPro\ResponseUtils;
    $config = require __DIR__ . '/config.php';
